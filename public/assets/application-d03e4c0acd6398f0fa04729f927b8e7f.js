...
(function() {
  $(function() {
    return $('.select.index').ready(function() {
      var $p_button, $p_name, switchButtonStyle;
      $p_name = $('#player_name');
      $p_button = $('#player_select_button');
      $('#player_select_button').on({
        click: function() {
          var c_type, name;
          name = $p_name.val();
          c_type = $('#chara_type').val();
          return location.href = '/select/show?name=' + name + '&c_type=' + c_type;
        }
      });
      switchButtonStyle = function() {
        if ($p_name.val().length > 0) {
          ...
          return $p_button.removeAttr("disabled");
        } else {
          $p_button.css({
            opacity: "0.6"
          });
          return $p_button.attr("disabled", "disabled");
        }
      };
      return $p_name.keyup(function(e) {
